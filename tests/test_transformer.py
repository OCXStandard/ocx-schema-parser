...
class TestTransformer:
    ...
    def test_get_simple_types_from_url(self, data_regression, transformer_from_url: Transformer):
        result =  {
            enum.name: enum.to_dict() for enum in transformer_from_url.get_simple_types()
        }
        data_regression.check(result)
